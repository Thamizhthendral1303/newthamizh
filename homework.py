# 1. Create an empty Students List
students_list = []

# 2. Create the following Functions with respective parameters and write the code for the process

# a) Function Name: add_student
# Parameters: Reg. No., Name, Marks
...
# b) Function Name: calculate_marks
# Parameter(s): Student Marks
...
# c) Function Name: display_students
# Parameter(s): Register No. (Default Value=ALL)
